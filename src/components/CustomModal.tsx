...
export function CustomModal({
  ...
  const cardBorder = isLight
    ? theme.colors.lightGlass.cardBorder
    : "rgba(255, 255, 255, 0.08)";
  const textColor = "#ffffff";
  const textMuted = isLight ? theme.colors.lightGlass.textMuted : "#a0a0a5";
  const rowInactiveBg = isLight
    ? theme.colors.lightGlass.rowInactive
    : "rgba(255, 255, 255, 0.05)";
  const rowBorder = isLight
    ? theme.colors.lightGlass.rowBorder
    : "rgba(255, 255, 255, 0.08)";
    ...
    >
      <View style={[styles.modalOverlay, { backgroundColor: scrimColor }]}>
        ...
        >
          ...
          {message && (
            <Text style={[styles.modalMessage, { color: textMuted }]}>
              {message}
            </Text>
          )}
          ...
          {children ? (
            ...
            <View style={styles.modalButtonRow}>
              <TouchableOpacity
                style={[
                  ...
                  { backgroundColor: rowInactiveBg, borderColor: rowBorder },
                ]}
                onPress={onClose}
                activeOpacity={0.7}
              >
                <Text style={[styles.modalCancelBtnText, { color: textColor }]}>
                  Cancel
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  ...
                  confirmDestructive
                    ? styles.modalConfirmBtnDestructive
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={[styles.modalOkBtnText, { color: textColor }]}>
                OK
              </Text>
            </TouchableOpacity>
          )}
